...
package happyworm.jPlayer {
	...
	public class ConnectManager extends Object {
		...
		public function ConnectManager() {
			trace ("ConnectManager Initialized");
		...
		public function negotiateConnect(ncRef:Object,p_serverName:String,p_appName:String)
		{
			_ncRef=ncRef;
			...
			_aNC[event.target.client.id].client.pending = true;
				...
				case "NetConnection.Call.Failed":
					...
					*/
					...
					var _nc = NetConnection(event.target);
					var connID:Number = event.target.client.id;
					var _actualPort = m_connList[m_connListCounter].port;
					var _actualProtocol = m_connList[m_connListCounter].protocol;
															
					// See if we have version info
					var _serverVersion = "UNKNOWN";
