...
package happyworm.jPlayer
{
	...
	public class JplayerRtmp extends Sprite
	{
		...
		function parseRTMPsrcConnect(rtmpSrc:String):Object
		{
	...
	//rtmp, rtmpt, rtmps, rtmpe, rtmpte
		...
		public function load():Boolean
		{
			...
			if (myStatus.loadRequired())
			{
				...
				trace("**** CONNECT SOURCE: " +connectString.hostName +" "+ connectString.appName);
	...
	public function pause(time:Number=NaN):Boolean
	{
		...
		*/
		...
		{
			if (myStatus.metaDataReady && myStatus.pausePosition > myStatus.duration)
